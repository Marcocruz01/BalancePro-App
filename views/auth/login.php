    ...
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div class="md:bg-gray-50 md:border md:border-gray-200 md:rounded-xl md:shadow-sm md:p-8">
            ...
            <div class="sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <h1 class="mt-8 text-center text-2xl/9 font-bold tracking-tight text-gray-900">Inicia sesión con tu cuenta</h1>
                <p class="text-center text-gray-600 font-normal">Accede a tu cuenta de forma <span class="text-blue-600 font-semibold">segura</span> y mantén tus finanzas bajo control.</p>
            </div>
            <!-- Formulario -->
            <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-sm">
                <form action="/login" method="POST" class="space-y-6">
                    ...
                    <div>
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-sm">
                                <a href="/olvide-password" class="font-semibold text-blue-600 hover:text-blue-500">¿Olvidaste tu contraseña?</a>
                            </div>
                        </div>
                        <div class="mt-2">
                            <input type="password" id="password" placeholder="Tu contraseña" name="password" class="block w-full rounded-md border border-gray-200 bg-gray-50 md:bg-white px-3 py-1.5 text-base text-gray-900 placeholder:text-gray-400 outline-1 -outline-offset-1 outline-gray-300 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-500 sm:text-sm/6">
                        </div>
                    </div>
                    <!-- Campos -->
                    <div>
                        <button type="submit" class="flex w-full justify-center rounded-md bg-zinc-900 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-zinc-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">Iniciar sesión</button>
                    </div>
                </form>
                ...
                <p class="mt-10 text-center text-sm/6 text-gray-500">
                    ...
                    <a href="/crear-cuenta" class="font-semibold text-blue-600 hover:text-blue-500"> Únete con plan gratis por 14 días</a>
                </p>
            </div>
        </div>
    </div>
